...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  /* grid data */
  const mwSize *grid_dims_64 = mxGetDimensions(PHI);
  ...
  DISTANCE_FUNCTION = mxCreateDoubleMatrix(grid_dims_64[0], grid_dims_64[1], mxREAL);
  ...
  for (i = 0; i < num_ext_fields; i++) {
    tmp_mxArray = mxCreateDoubleMatrix(grid_dims_64[0], grid_dims_64[1], mxREAL);
  ...
  int grid_dims[2];
  grid_dims[0] = grid_dims_64[0];
  grid_dims[1] = grid_dims_64[1];
